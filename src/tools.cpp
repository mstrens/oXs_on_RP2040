...
// list of fileds being used
    ...
    uint16_t listFieldsID[SPORT_TYPES_MAX] = {GPS_LONG_LATI_FIRST_ID , GPS_LONG_LATI_FIRST_ID ,GPS_SPEED_FIRST_ID, GPS_COURS_FIRST_ID , ALT_FIRST_ID, T1_FIRST_ID  ,\
                          ...
                          ALT_FIRST_ID} ;
    uint8_t listdeviceID[SPORT_TYPES_MAX] = {DATA_ID_GPS, DATA_ID_GPS, DATA_ID_GPS, DATA_ID_GPS, DATA_ID_VARIO , DATA_ID_RPM ,\
