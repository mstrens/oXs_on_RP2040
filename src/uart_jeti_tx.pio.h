...
#define uart_jeti_tx_wrap_target 0
#define uart_jeti_tx_wrap 3

static const uint16_t uart_jeti_tx_program_instructions[] = {
            //     .wrap_target
...
#if !PICO_NO_HARDWARE
static const struct pio_program uart_jeti_tx_program = {
    .instructions = uart_jeti_tx_program_instructions,
    .length = 4,
    .origin = -1,
};

static inline pio_sm_config uart_jeti_tx_program_get_default_config(uint offset) {
    pio_sm_config c = pio_get_default_sm_config();
    sm_config_set_wrap(&c, offset + uart_jeti_tx_wrap_target, offset + uart_jeti_tx_wrap);
