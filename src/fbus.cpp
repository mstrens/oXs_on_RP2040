...
void setupFbusList(){     // table used by fbus
    ...
    for (uint8_t i = 0; i < NUMBER_MAX_IDX ; i++){
        fbusPriority[i]= temp[i];
    }
    
    // code used by fbus to identify a field in a fbus frame
    fbusFieldId[LATITUDE] = GPS_LONG_LATI_FIRST_ID;
    fbusFieldId[LONGITUDE] = GPS_LONG_LATI_FIRST_ID;
    fbusFieldId[GROUNDSPEED] = GPS_SPEED_FIRST_ID;
    fbusFieldId[HEADING] = GPS_COURS_FIRST_ID;
    fbusFieldId[ALTITUDE] = GPS_ALT_FIRST_ID;
    fbusFieldId[NUMSAT] = DIY_GPS_NUM_SAT;
    fbusFieldId[GPS_DATE] = GPS_TIME_DATE_FIRST_ID;
    fbusFieldId[GPS_TIME] = GPS_TIME_DATE_FIRST_ID;
    fbusFieldId[GPS_PDOP] = DIY_GPS_PDOP;
    fbusFieldId[GPS_HOME_DISTANCE] = DIY_GPS_HOME_DISTANCE;
    fbusFieldId[GPS_HOME_BEARING] = DIY_GPS_HOME_BEARING;
    fbusFieldId[MVOLT] = VFAS_FIRST_ID;
    fbusFieldId[CURRENT] = CURR_FIRST_ID;
    fbusFieldId[RESERVE1] = DIY_VOLT3;
    fbusFieldId[RESERVE2] = DIY_VOLT4;
    fbusFieldId[CAPACITY] = DIY_CAPACITY;
    fbusFieldId[TEMP1] = T1_FIRST_ID; 
    fbusFieldId[TEMP2] = T2_FIRST_ID ;
    fbusFieldId[VSPEED] = VARIO_FIRST_ID;
    fbusFieldId[RELATIVEALT] = ALT_FIRST_ID ;
    fbusFieldId[PITCH] = DIY_PITCH;
    fbusFieldId[ROLL] = DIY_ROLL;
    //fbusFieldId[YAW] = DIY_YAW;
    fbusFieldId[RPM] = RPM_FIRST_ID;
    fbusFieldId[ADS_1_1] = DIY_ADS_1_1;
    fbusFieldId[ADS_1_2] = DIY_ADS_1_2;
    fbusFieldId[ADS_1_3] = DIY_ADS_1_3;
    fbusFieldId[ADS_1_4] = DIY_ADS_1_4;
    fbusFieldId[ADS_2_1] = DIY_ADS_2_1;
    fbusFieldId[ADS_2_2] = DIY_ADS_2_2;
    fbusFieldId[ADS_2_3] = DIY_ADS_2_3;
    fbusFieldId[ADS_2_4] = DIY_ADS_2_4;
    
    fbusMaxPooling[LATITUDE] = 10;
    fbusMaxPooling[LONGITUDE] = 10;
    fbusMaxPooling[GROUNDSPEED] = 20;
    fbusMaxPooling[HEADING] = 50;
    fbusMaxPooling[ALTITUDE] = 50;
    fbusMaxPooling[NUMSAT] = 200;
    fbusMaxPooling[GPS_DATE] = 200;
    fbusMaxPooling[GPS_TIME] = 200;
    fbusMaxPooling[GPS_PDOP] = 200;
    fbusMaxPooling[GPS_HOME_BEARING] = 50;
    fbusMaxPooling[GPS_HOME_DISTANCE] = 50;
    fbusMaxPooling[MVOLT] = 50;
    fbusMaxPooling[CURRENT] = 50;
    fbusMaxPooling[RESERVE1] = 50;
    fbusMaxPooling[RESERVE2] = 50;
    fbusMaxPooling[CAPACITY] = 200;
    fbusMaxPooling[TEMP1] = 50;
    fbusMaxPooling[TEMP2] = 50;
    fbusMaxPooling[VSPEED] = 5;
    fbusMaxPooling[RELATIVEALT] = 20;
    fbusMaxPooling[PITCH] = 20;
    fbusMaxPooling[ROLL] = 20;
    fbusMaxPooling[YAW] = 100;
    fbusMaxPooling[RPM] = 50;
    fbusMaxPooling[ADS_1_1] = 200;
    fbusMaxPooling[ADS_1_2] = 200;
    fbusMaxPooling[ADS_1_3] = 200;
    fbusMaxPooling[ADS_1_4] = 200;
    fbusMaxPooling[ADS_2_1] = 200;
    fbusMaxPooling[ADS_2_2] = 200;
    fbusMaxPooling[ADS_2_3] = 200;
    fbusMaxPooling[ADS_2_4] = 200;

    fbusMinPooling[LATITUDE] = 5;
    fbusMinPooling[LONGITUDE] = 5;
    fbusMinPooling[GROUNDSPEED] = 10;
    fbusMinPooling[HEADING] = 30;
    fbusMinPooling[ALTITUDE] = 30;
    fbusMinPooling[NUMSAT] = 100;
    fbusMinPooling[GPS_DATE] = 100;
    fbusMinPooling[GPS_TIME] = 100;
    fbusMinPooling[GPS_PDOP] = 100;
    fbusMinPooling[GPS_HOME_BEARING] = 30;
    fbusMinPooling[GPS_HOME_DISTANCE] = 30;
    fbusMinPooling[MVOLT] = 30;
    fbusMinPooling[CURRENT] = 30;
    fbusMinPooling[RESERVE1] = 30;
    fbusMinPooling[RESERVE2] = 30;
    fbusMinPooling[CAPACITY] = 100;
    fbusMinPooling[TEMP1] = 30;
    fbusMinPooling[TEMP2] = 30;
    fbusMinPooling[VSPEED] = 3;
    fbusMinPooling[RELATIVEALT] = 10;
    fbusMinPooling[PITCH] = 10;
    fbusMinPooling[ROLL] = 10;
    fbusMinPooling[YAW] = 50;
    fbusMinPooling[RPM] = 30;
    fbusMinPooling[ADS_1_1] = 50;
    fbusMinPooling[ADS_1_2] = 50;
    fbusMinPooling[ADS_1_3] = 50;
    fbusMinPooling[ADS_1_4] = 50;
    fbusMinPooling[ADS_2_1] = 50;
    fbusMinPooling[ADS_2_2] = 50;
    fbusMinPooling[ADS_2_3] = 50;
    fbusMinPooling[ADS_2_4] = 50;
    
    //for (uint8_t i = 0 ;  i< NUMBER_MAX_IDX ; i++){
    //    printf("deviceId %d = %x\n", i , fields[i].fbusDeviceId);
    //}
