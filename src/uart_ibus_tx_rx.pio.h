...
#define ibus_uart_tx_wrap_target 0
#define ibus_uart_tx_wrap 3

static const uint16_t ibus_uart_tx_program_instructions[] = {
            //     .wrap_target
...
#if !PICO_NO_HARDWARE
static const struct pio_program ibus_uart_tx_program = {
    .instructions = ibus_uart_tx_program_instructions,
    .length = 4,
    .origin = -1,
};

static inline pio_sm_config ibus_uart_tx_program_get_default_config(uint offset) {
    pio_sm_config c = pio_get_default_sm_config();
    sm_config_set_wrap(&c, offset + ibus_uart_tx_wrap_target, offset + ibus_uart_tx_wrap);
...
#define ibus_uart_rx_wrap_target 0
#define ibus_uart_rx_wrap 8

static const uint16_t ibus_uart_rx_program_instructions[] = {
            //     .wrap_target
...
#if !PICO_NO_HARDWARE
static const struct pio_program ibus_uart_rx_program = {
    .instructions = ibus_uart_rx_program_instructions,
    .length = 9,
    .origin = -1,
};

static inline pio_sm_config ibus_uart_rx_program_get_default_config(uint offset) {
    pio_sm_config c = pio_get_default_sm_config();
    sm_config_set_wrap(&c, offset + ibus_uart_rx_wrap_target, offset + ibus_uart_rx_wrap);
    return c;
}
