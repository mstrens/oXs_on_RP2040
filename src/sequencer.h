...
#define SEQ_DEFINITIONS {0,SERVO,20,3, -100}, {4,ANALOG,60,7, 0}
                
enum CH_RANGE {
    m100 = -100, m75 = -75, m50 = -50, m25 = -25, m0 = 0,
    p0 = 0, p25 = 25 , p50 = 50, p75 = 75, p100 = 100
};
...
struct SEQ_DATA {
    ...
    uint32_t smoothToMs;     // smoothing must end at this ms
    ...
    int8_t lastOutputVal;    // last value that has been applied on output pin.
};
